...
//-----------------------------------------------------------------------------
//----- AsdkDbEmployeeReactor.h : Declaration of the AsdkDbEmployeeReactor
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ AsdkDbEmployeeReactor : public AcDbDatabaseReactor {

public:
	ACRX_DECLARE_MEMBERS(AsdkDbEmployeeReactor) ;
...
public:
	AsdkDbEmployeeReactor (AcDbDatabase *pDb =NULL) ;
...
#ifdef STEP07_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(AsdkDbEmployeeReactor)
#endif
